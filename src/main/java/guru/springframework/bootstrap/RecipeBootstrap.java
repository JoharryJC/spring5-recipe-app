...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        //lo agregue yo
        Optional<UnitOfMeasure> onceUomOptional = unitOfMeasureRepository.findByDescription("Once");

        if (!onceUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }
        ...
        tacosRecipe.getIngredients().add(new Ingredient("Clove of Garlic, Choopedr", new BigDecimal(1), eachUom, tacosRecipe));
        ...
        tacosRecipe.getIngredients().add(new Ingredient("Line, cut into wedges", new BigDecimal(4), eachUom, tacosRecipe));
