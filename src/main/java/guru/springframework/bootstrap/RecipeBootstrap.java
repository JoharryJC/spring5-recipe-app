...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        tacosRecipe.addIngredient(new Ingredient("Clove of Garlic, Choopedr", new BigDecimal(1), eachUom));
        ...
        tacosRecipe.addIngredient(new Ingredient("Line, cut into wedges", new BigDecimal(4), eachUom));
